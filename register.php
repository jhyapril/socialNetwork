...
<head>
    <title>Welcome to SocialNetwrok</title>
...
} else if (in_array("Your password must be between 3 and 30 characters<br />", $error_array)) {
    echo "Your password must be between 3 and 30 characters<br />";
}
?>
